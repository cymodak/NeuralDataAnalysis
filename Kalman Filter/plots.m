...
plot(M(1),M(2),'k+');
plot(Contour1(:,1),Contour1(:,2),'k-','color','red','LineWidth',1);
plot(Contour2(:,1),Contour2(:,2),'k-','color','red','LineWidth',1);
xlabel('Horizontal Position in mm');
ylabel('Vertical Position in mm');
title('Predicted Path (red) and Actual Path (black)');